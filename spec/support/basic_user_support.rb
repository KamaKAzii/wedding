...
def add_event
  ...
  select Time.now.strftime("%Y").strip, from: "event_date_1i" # year
  select Time.now.strftime("%B").strip, from: "event_date_2i" # month
  select Time.now.strftime("%e").strip, from: "event_date_3i" # day
  click_on "Add event"
